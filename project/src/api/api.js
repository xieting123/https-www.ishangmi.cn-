...
//商恋状态选择
export const updateMateStatus = params => {
    return axios.post(`${base}/mate/updateMateStatus`, qs.stringify(params)).then(res => res.data);
};
...
export const workVerifySubmit = params => {
    return axios.post(`${base}/user/accounts/workVerifySubmit`,params).then(res => res.data);
};
//查看审核状态
export const getWorkVerifyByWorkId = params => {
    return axios.post(`${base}/user/accounts/getWorkVerifyByWorkId`,qs.stringify(params)).then(res => res.data);
};
...
//商人（分页，搜索）
export const getBusinessListLim = params => {
    return axios.post(`${base}/user/getBusinessListLim`, qs.stringify(params)).then(res => res.data);
};
// 商脉推荐
...
//商友列表分页
export const momentSYouListLim = params => {
    return axios.post(`${base}/moments/momentSYouListLim`, qs.stringify(params)).then(res => res.data);
};
...
//修改动态. 商脉
export const updateMoment = params => {
    return axios.post(`${base}/moments/updateMoment`,params).then(res => res.data);
};
