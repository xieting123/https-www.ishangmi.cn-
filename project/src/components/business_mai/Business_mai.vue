        ...
        <div class="main layoutWrap2 clearfix shanglian">
           <div  class="business-love_left lt">
      	   ...
      	   <router-view :key='1'></router-view>
                    ...
                    <li class="lt" v-for="item in maiSelection2" v-bind:key="item.index">
                        <div class="serchItem">
                 ...
                 <div v-if='form.identityId==4'>
                    ...
                    :total="total"
                    :current-page=1
                    :page-size='pageSize2' v-if="total2>pageSize2">
                </el-pagination></div>
                <div v-else>
                     <el-pagination class="paginationWrap_nav"
                    @current-change="handleCurrentChange"
...
<script>
    import {getSMaiSelection,getSMaiListLim,getBusinessListLim,getSMaiRecommend,accountsLike,accountsCancelLike} from '@/api/api';
    ...
    export default {
        data() {
            return {
                ...
                maiSelection2:[{userIdentity:{identityName:''}}],
                maiRecommend:[],
                form: {
                    keywords: '',
                    provinceId:'',
        ...
        methods: {
            ...
            onLoveSubmit(pageNum) {
                ...
                if(this.form.identityId==4){
                        getBusinessListLim(data).then(res => {
                    this.loading = false;
                    if (res.code === 200) {
                       
                        this.maiSelection2 = res.result.list;
