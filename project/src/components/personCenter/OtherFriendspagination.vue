  ...
  <div class="pagination paginationIndex">
                    <!-- 分页  -->
                        <el-pagination class="paginationWrap_nav"
                            ...
                            :current-page=1
                            :page-size='friendListPageSize'
                            v-if="friendListTotal>friendListPageSize"
                            >
                        </el-pagination>
                    </div>
</div>
        ...
        data(){
            return {
             ...
             OtherFanspagination:[],
                ...
                business_ju: [],
                business_pin: [],
                friendListTotal:0,//他的关注
                friendListPageSize:0,//他的关注分页
                totalCount:0,//商脉
                totalCount1:0,//商机
                totalCount2:0,//商会
                totalCount3:0,//商询
            ...
            getOtherFriendsList(pageNum,pageSize){
                ...
                getOtherFriendsList(data).then(res=>{
                    ...
                    this.OtherFriendspagination=res.result.pagination;
                     this.friendListTotal=res.result.pagination.totalCount;
                    this.friendListPageSize=res.result.pagination.pageSize
                    }
                    else {
                        this.$message({
                            message: res.msg,
