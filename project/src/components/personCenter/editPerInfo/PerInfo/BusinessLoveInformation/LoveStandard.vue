             ...
             <div class="page-limit">
                 <div class="pageWrap">
                    <el-form ref="form" :model="form"  label-position="left" label-width="160px" class="bussessloveWrap">
                        ...
                        <el-form-item label="体重" prop="weightStarts" class="inlineForm_love">
                            <template>
                                <el-select v-model="weightStarts" placeholder="请选择体重" value-key="a" @change='changeWeight'>
                                <el-option
                        ...
                        <el-form-item label="至" label-width="50px" prop="weightEnds" class="inlineForm_love inlineForm_second">
                            <template>
                                <el-select v-model="weightEnds" placeholder="请选择体重" value-key="b" @change='changeWeight2'>
                                <el-option
                                v-for="item in weightData"
                                :key="item.index"
                                :label="item+'kg'"
           ...
           //设置年龄范围
            ...
            onSubmit(formName) {
                let data ={
                    ...
                    mateWeight:this.weightStarts+'-'+this.weightEnds,
               ...
               console.log(typeof(this.form.mateHeight),330);
                ...
                getMateSelectionByUserId(data).then(res => {
                    if (res.code === 200) {
                        if(res.result){
                            ...
                            this.weightStarts=Number(this.form.mateWeight.match(/\d+/g)[0]);
                            this.weightEnds=Number(this.form.mateWeight.match(/\d+/g)[1])+'kg';
                            ...
                            console.log(typeof(this.form.heightStart) ,374);
