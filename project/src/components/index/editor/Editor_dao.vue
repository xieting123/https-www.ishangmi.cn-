<template>
  <div class="container Editor_Dao">
    <div class="topFix">
      <div id="header">
        <myHeader></myHeader>
      </div>
      ...
      <div class="page-limit">
        <div class="pageWrap">
          ...
          <el-form ref="form" :model="form" label-width="98px">
            ...
            <el-form-item class="switchItemWrap">
              <div class="switchItem">
                <img
                  v-show="labelFlag1"
                  @click="switchFlag"
                  src="../../../assets/personCenter/print.png"
                  alt
                  width="25"
                >
                <img
                  v-show="labelFlag2"
                  @click="switchFlag"
                  src="../../../assets/personCenter/printAgreed.png"
                  alt
                  width="25"
                >
                <span>原创</span>
            ...
            <el-form-item>
              <div class="btnGroups">
                <a href="javascript:;" class="btnPlain lt" @click="goBack('/personCenter/Contentmanagement/myshangdao')">取消</a>
...
import { richTextFileUpload, avenuesUpdate, avenuesDetail } from "@/api/api";
export default {
      name: "Editor_Dao",
  components: {
    VueUeditorWrap,
  ...
  methods: {
    ...
    avenuesDetail() {
      ...
      avenuesDetail(data).then(
        res => {
          if (res.code === 200) {
            this.form = res.result;
            if (this.form.isOriginal === 1) {
              this.labelFlag1 = false;
              this.labelFlag2 = true;
            } else {
              this.labelFlag1 = true;
    ...
    onSubmit() {
      ...
      let vm = this;
      avenuesUpdate(data).then(
        res => {
          if (res.code === 200) {
            this.$message.success("修改商道成功！");
            setTimeout(function() {
...
<style>
.Editor_Dao .el-form-item__content {
  line-height: 0;
}
