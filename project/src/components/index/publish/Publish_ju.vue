    ...
    export default {
        ...
        methods: {
            ...
            onSubmit() {
                ...
                this.uploadForm.set('coverFile', this.form.coverFile);
                this.uploadForm.set('title', this.form.title);
                this.uploadForm.set('tradeId', this.form.tradeId);
                this.uploadForm.set('beginTime', this.form.beginTime);
                this.uploadForm.set('endTime', this.form.endTime);
                this.uploadForm.set('signUpEndTime', this.form.signUpEndTime);
                this.uploadForm.set('provinceId', this.form.provinceId);
                this.uploadForm.set('cityId', this.form.cityId);
                this.uploadForm.set('addressDetail', this.form.addressDetail);
                this.uploadForm.set('organizers', this.form.organizers);
                this.uploadForm.set('activityDetails', this.form.activityDetails);
                this.uploadForm.set('price', parseInt(this.form.price));
