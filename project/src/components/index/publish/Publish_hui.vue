    ...
    export default {
        ...
        methods: {
            ...
            beforeUpload1 (file) {   // before-upload
                this.uploadForm.set('tissueCoverPhotofile', file)
                return false;
            },
            beforeUpload2 (file) {
                this.uploadForm.set('qualificationContentFile', file)
                return false;
            },
            onSubmit(formName) {
                if(this.checked){
                    ...
                    this.uploadForm.set('tissueName', this.form.tissueName);
                    this.uploadForm.set('tissueJoinCost', this.form.tissueJoinCost);
                    this.uploadForm.set('tradeId', this.form.tradeId);
                    this.uploadForm.set('tissueIntroduction', this.form.tissueIntroduction);
                    this.uploadForm.set('isAgree', parseInt(this.form.isAgree));
