...
<img class='sex'  v-else-if='listData.sex==-1' src=''>
<img class='sex'  v-else src='../../assets/index/images/icon_男性.png'>
<!-- <span class='identity'>{{listData.user.userIdentity.identityName}}</span> -->
<img v-if="listData.user.verifyStatus===2" style='width:60px;height:20px;vertical-align: middle;' src='../../assets/index/images/icon_实人认证@3x.png'>
<br>
