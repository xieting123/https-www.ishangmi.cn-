...
import Business_you from '@/components/business_you/business_you'
// 导航多级
...
import textEditor2 from '@/components/common/editor2'
...
import Editor_mai from '@/components/index/editor/Editor_mai' 
...
import corporateIdentity from '@/components/personCenter/corporateIdentity'
...
//认证
import identifies from '@/components/personCenter/editPerInfo/PerInfo/identifies.vue'
import VerifyStates from '@/components/personCenter/editPerInfo/PerInfo/VerifyStates.vue'
import worksVerifyStates from '@/components/personCenter/editPerInfo/PerInfo/worksVerifyStates.vue'
import workVerifyStates from '@/components/personCenter/editPerInfo/PerInfo/workVerifyStates.vue'
import reallyName from '@/components/personCenter/editPerInfo/PerInfo/reallyName.vue'
import reallyWork from '@/components/personCenter/editPerInfo/PerInfo/reallyWork.vue'
import CertificationMaterials from '@/components/personCenter/editPerInfo/PerInfo/CertificationMaterials.vue'
import ViewWorkState from '@/components/personCenter/editPerInfo/PerInfo/ViewWorkState.vue'
...
var router = new Router({
    ...
    routes: [
        ...
        {
            path: '/index/editorMai',
            name: 'Editor_mai',
            meta: {
                requireAuth: true,
            },
            component: Editor_mai
        },
        // {
                ...
                path: 'businessLove_mate',
                    ...
                    component: Blacklist
                        ...
                        //认证状态
                        {
                            ...
                            component: VerifyStates
                                }, 
                                //认证状态 职务
                                {
                                    path: 'worksVerifyStates',
                                    name: 'worksVerifyStates',
                                    meta: {
                                    requireAuth: true, 
                            },
                                    component: worksVerifyStates
                                        }, 
                            //职务认证状态
                        {
                            path: 'workVerifyStates',
                            name: 'workVerifyStates',
                            meta: {
                            requireAuth: true, 
                    },
                            component: workVerifyStates
                                }, 
                                //职务认证材料上传
                        {
                            path: 'CertificationMaterials',
                            name: 'CertificationMaterials',
                            meta: {
                            requireAuth: true, 
                    },
                            component: CertificationMaterials
                                }, 
                                //查看认证状态
                                {
                                    path: 'ViewWorkState',
